...
public class InorganicCInstr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inorganic_c_instr);
...
//        mydatabase.removeValue();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InorganicCInstr.this, InorganicCTest.class);
