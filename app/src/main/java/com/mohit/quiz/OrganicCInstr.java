...
public class OrganicCInstr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organic_c_instr);
...
//        mydatabase.removeValue();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrganicCInstr.this, OrganicCTest.class);
