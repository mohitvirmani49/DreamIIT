...
public class PhysicalResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("My va;ue" + value);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PhysicalResult.this, PhysicalResultCheck.class);
                startActivity(intent);
...
//        databaseReference.child("Maths").push().setValue(user);
        ...
        detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PhysicalResult.this, MathsDetail.class);
