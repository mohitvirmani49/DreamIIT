...
public class OrganicResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organic_result);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrganicResult.this, OrganicV.class);
                startActivity(intent);
...
//        databaseReference.child("Maths").push().setValue(user);
        ...
        detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OrganicResult.this, MathsDetail.class);
