...
public class InorganicResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inorganic_result);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InorganicResult.this, InorganicVerify.class);
                startActivity(intent);
...
//        databaseReference.child("Maths").push().setValue(user);
        ...
        detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InorganicResult.this, MathsDetail.class);
