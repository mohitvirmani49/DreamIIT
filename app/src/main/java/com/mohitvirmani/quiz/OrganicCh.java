...
public class OrganicCh extends AppCompatActivity implements Phy_Adapter.OnItemClickListener {
...
//        List<Phy> list = new ArrayList<>();
        ...
        Phy_Adapter mAdapter2 = new Phy_Adapter(OrganicCh.this, list);
//        mAdapter = new Phy_Adapter(Main29Activity.this,mUploads);

        mAdapter2.setOnItemClickListener(OrganicCh.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OrganicCh.this, ChemistryCard.class);
...
//
    ...
    public void itemClicked(int position) {
        ...
        Intent intent = new Intent(OrganicCh.this, OrganicPracticeInstr.class);
        startActivity(intent);
