...
//            @Override
//            public void onClick(View v) {
//                Intent myIntent = new Intent(Main5Activity.this, Main3Activity.class);
...
//
//        } else {
//            reference = FirebaseDatabase.getInstance().getReference().child("Sequence_easy").child(String.valueOf(total));
//            total++;
