...
public class InorganicPracticeTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inorganic_practice_test);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(InorganicPracticeTest.this)
    ...
    private void submitTest() {
        Intent myIntent = new Intent(InorganicPracticeTest.this, MathsResultPractice.class);
