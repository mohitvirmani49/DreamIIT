...
public class PhysicalCTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physical_c_test);
...
//        Query query = FirebaseDatabase.getInstance().getReference()
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(PhysicalCTest.this)
...
//
            ...
            reference = FirebaseDatabase.getInstance().getReference("Physical Chem").child(intent.getStringExtra("val")).child(String.valueOf(array[alpha]));
            alpha++;
            number.setText("Q" + no + " :");
            no++;
...
//                                updates.put("correctAns", question.getAnswer());
    ...
    private void startTimer() {
        ...
        new CountDownTimer(1800000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(PhysicalCTest.this, "Time is up! Your test has been submitted automatically", Toast.LENGTH_LONG).show();
                submitTest();
    ...
    private void submitTest() {
        ...
        Intent myIntent = new Intent(PhysicalCTest.this, PhysicalResult.class);
